...
def total():
    ...
    Latte, Espresso, Iced_latte, SexOn, Cappucino = 60, 60, 60, 60, 60
    Frappé, Doppio, Iced_cap, Mojito = 60, 60, 60, 60
    Cheese, Red, Pasta, lasagna, Carnitas = 550, 650, 450, 600, 500
    Cheeseburger, Layered, choc, Reuben = 350, 1050, 1000, 200
...
def recipt():
    ...
    g.listbox.insert("end", "                                                 ")
    if g.var1.get() == 1: g.listbox.insert("end", "     Pepsi                                                {}                                            {}".format(g.Latte_Entry.get(), total_tuple[5]))
    if g.var2.get() == 1: g.listbox.insert("end", "     Coca Cola                                        {}                                            {}".format(g.Espresso_Entry.get(), total_tuple[6]))
    if g.var3.get() == 1: g.listbox.insert("end", "     Sprite                                               {}                                            {}".format(g.Iced_latte_Entry.get(), total_tuple[7]))
    if g.var4.get() == 1: g.listbox.insert("end", "     Fanta                                               {}                                            {}".format(g.SexOn_Entry.get(), total_tuple[8]))
    if g.var5.get() == 1: g.listbox.insert("end", "     Gourmet                                          {}                                            {}".format(g.Cappucino_Entry.get(), total_tuple[9]))
    if g.var6.get() == 1: g.listbox.insert("end", "     7 Up                                                 {}                                            {}".format(g.Frappé_Entry.get(), total_tuple[10]))
    if g.var7.get() == 1: g.listbox.insert("end", "     Next Cola                                         {}                                            {}".format(g.Doppio_Entry.get(), total_tuple[11]))
    if g.var8.get() == 1: g.listbox.insert("end", "     Lemon Malt                                     {}                                            {}".format(g.Iced_cap_Entry.get(), total_tuple[12]))
    if g.var9.get() == 1: g.listbox.insert("end", "     Mountain Dew                                {}                                            {}".format(g.Mojito_Entry.get(), total_tuple[13]))
    ...
    if g.var13.get() == 1: g.listbox.insert("end", "     Lasagna                                             {}                                          {}".format(g.lasagna_Entry.get(), total_tuple[17]))
    if g.var14.get() == 1: g.listbox.insert("end", "     Cheese Platter                                   {}                                          {}".format(g.Carnitas_Entry.get(), total_tuple[18]))
    ...
    if g.var18.get() == 1: g.listbox.insert("end", "     Chicken Sandwich                            {}                                          {}".format(g.Reuben_Entry.get(), total_tuple[22]))
