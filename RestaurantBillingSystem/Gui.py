...
Checkbutton_Latte.configure(text="Pepsi")
...
Espresso_Checkbutton.configure(text="Coca Cola")
...
Iced_latte_Checkbutton.configure(text="Sprite")
...
SexOn_Checkbutton.configure(text="Fanta")
...
Cappucino_Checkbutton.configure(text="Gourmet")
...
Frappé_Checkbutton.configure(text="7 Up")
...
Doppio_Checkbutton.configure(text="NEXT Cola")
...
Iced_cap_Checkbutton.configure(text="Lemon Malt")
...
Mojito_Checkbutton.configure(text="Mountain Dew ")
...
lasagna_Checkbutton.configure(text="Lasagna ")
...
Carnitas_Checkbutton.configure(text="Cheese Platter")
...
Reuben_Checkbutton.configure(text="Chicken sandwich")
